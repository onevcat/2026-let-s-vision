...
<CompareColumn title="正在弱化" variant="fading" class="mr-3">
...
<CompareColumn title="正在增强" variant="rising" class="ml-3">
...
<!--
前面讲了三组核心话题，其实还有很多发现。时间有限，速览几条。

弱化：DRY 边际下降、语言专精护城河被拉平、Review 从"怎么写"到"要什么"、调试风格转变。
增强：知识共享透明、架构杠杆放大、自主改善成为可能、为 Agent 而写的时代。
